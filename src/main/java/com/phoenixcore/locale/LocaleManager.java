...
public class LocaleManager {
    ...
    /**
     * Devuelve un mensaje traducido con el prefijo configurado (para mensajes de chat).
    ...
    /**
     * Devuelve un mensaje sin prefijo (útil para títulos, nombres o lore de ítems).
     */
     ...
     * Útil para mensajes multilínea en chat (ej: "core-info")
     */
    ...
    /**
     * Devuelve una lista de mensajes sin prefijo (para lore o títulos).
     */
